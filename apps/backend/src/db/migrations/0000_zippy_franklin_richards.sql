...
CREATE TYPE "public"."turf_subscription_status" AS ENUM('TRIAL', 'ACTIVE', 'EXPIRED', 'CANCELLED');--> statement-breakpoint
CREATE TYPE "public"."turf_verification_status" AS ENUM('PENDING', 'VERIFIED', 'REJECTED', 'SUSPENDED');--> statement-breakpoint
CREATE TYPE "public"."user_status" AS ENUM('ACTIVE', 'BLOCKED');--> statement-breakpoint
CREATE TYPE "public"."permission" AS ENUM('MANAGE_PLATFORM', 'MANAGE_TURFS', 'MANAGE_SUBSCRIPTIONS', 'MANAGE_PLAYERS', 'MANAGE_MATCHES', 'SCORE_MATCH', 'VIEW_STATS', 'VIEW_LEADERBOARDS', 'MANAGE_SCORERS');--> statement-breakpoint
CREATE TYPE "public"."role" AS ENUM('SUPER_ADMIN', 'TURF_ADMIN', 'SCORER', 'PLAYER');--> statement-breakpoint
...
CREATE TABLE "turfs" (
	...
	"logo_url" text,
	"map_location" text,
	"verification_status" "turf_verification_status" DEFAULT 'PENDING',
	"verified_at" timestamp,
	"verified_by" uuid,
	"subscription_status" "turf_subscription_status" DEFAULT 'TRIAL',
...
ALTER TABLE "turfs" ADD CONSTRAINT "turfs_verified_by_users_id_fk" FOREIGN KEY ("verified_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "matches" ADD CONSTRAINT "matches_active_scorer_id_users_id_fk" FOREIGN KEY ("active_scorer_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_roles" ADD CONSTRAINT "user_roles_turf_id_turfs_id_fk" FOREIGN KEY ("turf_id") REFERENCES "public"."turfs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "subscriptions" ADD CONSTRAINT "subscriptions_turf_id_turfs_id_fk" FOREIGN KEY ("turf_id") REFERENCES "public"."turfs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
